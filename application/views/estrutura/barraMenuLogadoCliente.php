                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            <li class="hassubs">
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url('ControllerLogin/listaCate/arroz'); ?>">Arroz<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/feijao'); ?>">Feijão<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/sal'); ?>">Sal<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/acucar'); ?>">Açucar<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/massas'); ?>">Massas<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/oleos'); ?>">Oléos<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/laticinios'); ?>">Laticínios<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/paes'); ?>">Pães<i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </li>
                            <li class="hassubs">
                                <a href="#">Frios<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/carnes'); ?>">Carnes<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/aves'); ?>">Aves<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/peixes'); ?>">Peixes<i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </li>
                            <li class="hassubs">
                                <a href="#">Hortifruti<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/frutas'); ?>">Frutas<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/vegetais'); ?>">Vegetais<i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </li>
                            <li class="hassubs">
                                <a href="#">Bebidas<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/alcoolicas'); ?>">Alcoólicas<i class="fas fa-chevron-right"></i></a></li>
                                    <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/naoalcoolicas'); ?>">Não alcoólicas<i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/limpeza'); ?>">Produtos de limpeza <i class="fas fa-chevron-right ml-auto"></i></a></li>
                            <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/higiene'); ?>">Higiene<i class="fas fa-chevron-right"></i></a></li>
                            <li><a href="<?php echo base_url('ControllerCategoriasLogado/loginfeitoCliente/pet'); ?>">Pets<i class="fas fa-chevron-right"></i></a></li>
                        </ul>
                    </div>
