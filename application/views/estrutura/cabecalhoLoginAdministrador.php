...
<html>
    ...
    <body>
                        ...
                        <div class="mega-dropdown-menu">
                            <div class="w3ls_vegetables">
                                <ul class="dropdown-menu drp-mnu">
                                    ...
                                    <li><a href="<?php echo base_url('#'); ?>">Lista Pedidos</a></li>
                                    <li><a href="<?php echo base_url('#'); ?>">Relatório Vendas</a></li>
                                    <li><a href="<?php echo base_url('cadastroprodutos/'); ?>">Cadastro de Produtos</a></li>
                                    <li><a href="<?php echo base_url('listaproduto/'); ?>">Produtos cadastrados</a></li>
                                </ul>
                            </div>                  
                        </div>	
                    </li>
        ...
        <div class="logo_products">
            <div class="container">
                <div class="w3ls_logo_products_left">
                    <h1><a href="<?php echo base_url('administrador/') ?>"><img src="<?php echo base_url('application/images/Logo-Quick2.jpg'); ?>" width="130" height="100"></a></h1>
                </div>
        ...
        <div class="products-breadcrumb">
            <div class="container">
                <ul>
                    <li><img src="<?php echo base_url('application/images/home.png'); ?>" width="25" height="20"><a href="<?php echo base_url('administrador/') ?>">Inicio</a><span>|</span></li>
                    <li>**<span>|</span></li>
                    <li>**</li>
                </ul>
            </div>
