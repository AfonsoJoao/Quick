                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-3 col-3 order-1">
                                <div class="logo_container">
                                    <div class="logo"><a href="<?php echo base_url('home') ?>"><img src="<?php echo base_url('application/images/Logo-Quick.png') ?>" width="150" height="150"></a></div>
                                </div>
                            </div>
                                                                ...
                                                                <ul class="dropdown-menu carrinho-compra">
                                                                    ...
                                                                    <div class="row margin-top-20 btns-carrinho-topo d-none">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-6">
                                                                            <a href="<?= base_url('ControllerCarrinho/carrinhoLogado') ?>" title="Exibir Carrinho" class="btn btn-success btn-block">Exibir Carrinho</a>
                                                                        </div>
