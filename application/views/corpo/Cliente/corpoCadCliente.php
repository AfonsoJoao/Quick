        ...
        <div class="col-sm-6">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" class="cpf" name="cpf" placeholder="CPF" required="" value="<?php
                    if (isset($cliente))
                        foreach ($cliente as $cli) {
                            echo $cli->cpf;
                        }
                    ...
                    <input type="text" class="form-control" name="rg" placeholder="RG" required=" " value="<?php
                    if (isset($cliente))
                        foreach ($cliente as $cli) {
                            echo $cli->rg;
                        }
