            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control margin-top-2" class="cpf" id="input_cpf" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control margin-top-2" class="telefone"
                               id="telefone" name="tel" placeholder="Telefone" required="">
