...
<div class="card-deck">
  <div class="card border-primary">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Acesse o seu <b>e-mail</b> e procure pelo e-mail da nossa equipe com a sua nova senha teporária(caso não encontre verifique a sua lixeira).</p>
    </div>
  </div>
  <div class="card border-primary">
    <img src="<?php echo base_url('application/images/copiar.PNG') ?>" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Copiar senha</h5>
      <p class="card-text">copie sua senha temporária.</p>
    </div>
  </div>
</div>
<br>
...
<div class="card border-primary">
  ...
  <br>
  <center><a class="btn btn-primary" href="<?php echo base_url('login/')?>">Voltar para tela de login</a></center>
  <br>
  </body>
  </html>